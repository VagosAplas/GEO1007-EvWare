...
var search = {};
                ...
                search.date_start = document.getElementById('date_start').value;
                search.date_end = document.getElementById('date_end').value;
                search.stime = document.getElementById('stime').value;
                search.etime = document.getElementById('etime').value;
...
var showWFS = function(fet,eve) {
    ...
    cqlfilter += 'event_name not like \'' + fet.event_name + '\'';
    ...
    //str1 += ' AND event_type like \'lecture\'';
    //str1 += (' AND event_type not like \'' + fet.event_type + '\'');


    geojsonLayer.refresh(strx);
...
var geojsonLayer = new L.GeoJSON.AJAX("http://localhost:8080/geoserver/Raphael/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=Raphael:events_all&maxFeatures=1000&outputFormat=application%2Fjson");
